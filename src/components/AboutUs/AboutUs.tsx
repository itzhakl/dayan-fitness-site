...
const AboutUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id='about-us' className='gap-16 py-10 md:h-full md:pb-0' >
      {/* Images & Header */}
          <h1>{'מי אנחנו?'}</h1>
      <motion.div className='md:flex mx-auto w-5/6 items-center justify-center md:h-5/6' onViewportEnter={() => setSelectedPage(SelectedPage.AboutUs)}>
        {/* Main Header */}
