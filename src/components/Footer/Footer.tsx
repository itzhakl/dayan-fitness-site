    ...
    return (
        <section id='footer' className='bg-teal-600 snap-start py-16'>
            ...
            <iframe title='map' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3379.97805025074!2d34.831113800000004!3d32.0968789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d4b1ccab32179%3A0x9389ff23e682654d!2z15nXqdeo15DXnCDXldeY15zXmdeUINeT15nXmdefIC0g157XkNee16DXmSDXm9eV16nXqCDXkNeZ16nXmdeZ150g15XXp9eR15XXpteV16o!5e0!3m2!1siw!2sil!4v1715335093742!5m2!1siw!2sil" width="350" height="300" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                ...
                <div className='mt-16 basis-1/4 md:mt-0'>
                    <h4 className="font-bold">רשתות חברתיות</h4>
                    <a className='my-5' title='Instagram' target='blank' href='https://www.instagram.com/dayn_israel?r=nametag'><InstagramIcon /></a>
                    <a title='Facebook' target='blank' href='https://www.facebook.com/profile.php?id=100006389503448'><FacebookIcon /></a>
                    <a title='YouTube' target='blank' href='https://www.youtube.com/channel/UCnQ-OQZNPQ6SE47c-76v-pg'><YouTubeIcon /></a>
                </div>
                ...
                <div onClick={() => {
                    ...
                    }} className="fixed bottom-0 m-2 left-0">
                    <CopyrightIcon/>
                    {/* <p className='text-xs'>© נבנה על ידי יצחק לשינסקי</p>
                    <a className='text-xs' href='tel:+972535561849'>053-556-1849</a> */}
                </div>
            </motion.div>
        </section>
    );
